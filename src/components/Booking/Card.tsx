...
const BookinCard = ({ booking }: any) => {
  ...
  return (
    <div className={`w-full px-4 py-6 pr-16 flex flex-col gap-8 bg-white rounded-md shadow-md overflow-hidden relative transition-all duration-300 ${expand ? 'h-max' : 'h-[95px]'}`}>
      <div className="grid grid-cols-3 pb-6 border-b border-gray-400">
